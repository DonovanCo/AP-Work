...
public class Methods
	...
	public static void addToHalloween()
		{
		AdvRunner.halloween.add(new MonsterConstruct("Scary", "Demon"));
		AdvRunner.halloween.add(new MonsterConstruct("Big", "Troll"));
		AdvRunner.halloween.add(new MonsterConstruct("Eatser", "Egg"));
		AdvRunner.halloween.add(new MonsterConstruct("Santa", "Claus"));
		}
	...
	public static void transferToAskFirst()
		{
		do
			{
			Methods.askFirst();
	...
	public static void playAnyways()
		{
	...
	public static void checkCoiceBeginAdv()
		{
		if (Methods.choice.equals("a") || Methods.choice.equals("b"))
			{
			Methods.transferToAskFirst();
			} else
			{
			Methods.playAnyways();
			}
	...
	public static void askTwo()
		{
		System.out.println("You leave the room, and find yourself facing a "
				+ AdvRunner.halloween.get(0).getAdj() + " "
				+ AdvRunner.halloween.get(0).getMonsterType() + ".");
		System.out.println("Do you a.) run, b.) hide, or c.) fight");
		choice = game.nextLine();
		if (choice.equals("a"))
			{
			System.out
					.println("You get away safely and find "
							+ gold
			...
			{
			System.out
					.println("You try to fight the demon.\nAs you throw the first punch, it turns into an "
							+ AdvRunner.halloween.get(2).getAdj()
							+ " "
							+ AdvRunner.halloween.get(2).getMonsterType()
	...
	public static void checkRewardAsk()
		{
	...
	public static void giveReward()
		{
		System.out
				.println("Do you wish to receive your reward. a.) yes b.) no");
		choice = game.nextLine();
		if (choice.equals("a"))
			{
			if (easter == 1)
				...
				{
				System.out
						.println("You found all the easter eggs! Now go outside.");
				} else
				{
				System.out
						.println("You found no easter eggs. You aren't even MLG bro. 1v1 me.");
				}
			if (gold == 50)
				{
				System.out.println("You become "
						+ AdvRunner.halloween.get(3).getAdj() + " "
						+ AdvRunner.halloween.get(3).getMonsterType() + ".");
				} else if (gold == 1)
				{
				System.out.println("A" + AdvRunner.halloween.get(1).getAdj()
						+ " " + AdvRunner.halloween.get(1).getMonsterType()
						+ " walks up to you and says \"Get on my level.\"");
				} else
				{
				System.out.println("You had " + gold
						+ " gold pieces. You could do better.");
				}
			} else
			{
	...
	public static void playGame()
		{
		Methods.addToHalloween();
		Methods.beginAdv();
		Methods.checkCoiceBeginAdv();
		Methods.askTwo();
		Methods.checkRewardAsk();
		}
